        ...
        <nav id="sidebar">
            ...
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{getURL()}}/">
                        <img src="{{asset('public/storage/img/90x90.jpg')}}" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb' )
                    ...
                    <li class="menu {{ ($category_name === 'chat') ? 'active' : '' }}">
                        <a href="{{getURL()}}/apps/chat" aria-expanded="{{ ($category_name === 'chat') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'mailbox') ? 'active' : '' }}">
                        <a href="{{getURL()}}/apps/mailbox" aria-expanded="{{ ($category_name === 'mailbox') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'todo') ? 'active' : '' }}">
                        <a href="{{getURL()}}/apps/todoList" aria-expanded="{{ ($category_name === 'todo') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'notes') ? 'active' : '' }}">
                        <a href="{{getURL()}}/apps/notes" aria-expanded="{{ ($category_name === 'notes') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'scrumboard') ? 'active' : '' }}">
                        <a href="{{getURL()}}/apps/scrumboard" aria-expanded="{{ ($category_name === 'scrumboard') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'contacts') ? 'active' : '' }}">
                        <a href="{{getURL()}}/apps/contacts" aria-expanded="{{ ($category_name === 'contacts') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'invoice') ? 'active' : '' }}">
                        <a href="{{getURL()}}/apps/invoice" aria-expanded="{{ ($category_name === 'invoice') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'calendar') ? 'active' : '' }}">
                        <a href="{{getURL()}}/apps/calendar" aria-expanded="{{ ($category_name === 'calendar') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'fonticons') ? 'active' : '' }}">
                        <a href="{{getURL()}}/font_icons" aria-expanded="{{ ($category_name === 'fonticons') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'widgets') ? 'active' : '' }}">
                        <a href="{{getURL()}}/widgets" aria-expanded="{{ ($category_name === 'widgets') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'bootstrap_basic_table') ? 'active' : '' }}">
                        <a href="{{getURL()}}/tables/bootstrap_basic" aria-expanded="{{ ($category_name === 'bootstrap_basic_table') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'drag_n_drop') ? 'active' : '' }}">
                        <a href="{{getURL()}}/drag_and_drop" aria-expanded="{{ ($category_name === 'drag_n_drop') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'maps') ? 'active' : '' }}">
                        <a href="{{getURL()}}/maps" aria-expanded="{{ ($category_name === 'maps') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'charts') ? 'active' : '' }}">
                        <a href="{{getURL()}}/charts" aria-expanded="{{ ($category_name === 'charts') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
