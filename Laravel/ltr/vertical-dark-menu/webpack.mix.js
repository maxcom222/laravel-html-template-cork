...
mix.sass('resources/sass/assets/structure.scss', 'public/assets/css/')
   ...
   // DataTable
   .sass('resources/sass/plugins/table/datatable/custom_dt_custom.scss', 'public/plugins/table/')
   .sass('resources/sass/plugins/table/datatable/custom_dt_html5.scss', 'public/plugins/table/')
   .sass('resources/sass/plugins/table/datatable/custom_dt_miscellaneous.scss', 'public/plugins/table/')
   .sass('resources/sass/plugins/table/datatable/custom_dt_multiple_tables.scss', 'public/plugins/table/')
   .sass('resources/sass/plugins/table/datatable/datatables.scss', 'public/plugins/table/')
   .sass('resources/sass/plugins/table/datatable/datatables-light.scss', 'public/plugins/table/')
   .sass('resources/sass/plugins/table/datatable/dt-global_style.scss', 'public/plugins/table/')
   .sass('resources/sass/plugins/table/datatable/dt-global_style-light.scss', 'public/plugins/table/')
