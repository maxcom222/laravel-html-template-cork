/* flatpickr v4.6.2,, @license MIT */ ! function(e, t) {
    ...
    function y(f, g) {
            ...
            if (void 0 !== h.calendarContainer) {
                ...
                if (c(h.calendarContainer, "arrowTop", !s), c(h.calendarContainer, "arrowBottom", s), !h.config.inline) {
                    var f = window.pageXOffset + l.right - (null != r && "center" === r ? (a - l.width) / 2 : 0),
                        ...
                        custom1 = document.getElementsByTagName("body")[0],
                        custom2 = custom1.currentStyle || window.getComputedStyle(custom1);
                        console.log(parseInt(custom2.marginLeft) + 68)
                    if (c(h.calendarContainer, "rightMost", g), !h.config.static)
                        if (h.calendarContainer.style.top = u + "px", g)
                            ...
                            } else h.calendarContainer.style.left = "auto", h.calendarContainer.style.right = parseInt(custom2.marginLeft) + 68 + 'px';
        ...
        //   document.getElementsByClassName('sidenav')[0].style.left = custom2.marginRight;
        // }
