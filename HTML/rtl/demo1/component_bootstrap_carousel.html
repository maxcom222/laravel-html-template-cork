                                                ...
                                                <div id="style1" class="carousel slide style-custom-1" data-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner">
                                                        <div class="carousel-item active">
                                                            <img class="d-block w-100 slide-image" src="assets/img/640x426.jpg" alt="First slide">
                                                        ...
                                                        <div class="carousel-item">
                                                            <img class="d-block w-100 slide-image" src="assets/img/640x426.jpg" alt="Second slide">
                                                            <div class="carousel-caption">
                                                                <span class="badge">Lifestyle</span>
                                                        ...
                                                        <div class="carousel-item">
                                                            <img class="d-block w-100 slide-image" src="assets/img/640x426.jpg" alt="Third slide">
                                                            <div class="carousel-caption">
                                                                <span class="badge">Lifestyle</span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="d-block w-100" src="assets/img/640x426.jpg" alt="First slide">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" src="assets/img/640x426.jpg" alt="Second slide">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" src="assets/img/640x426.jpg" alt="Third slide">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
